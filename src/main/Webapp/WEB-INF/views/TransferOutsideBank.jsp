...
<hr/>
<spring:form action="${pageContext.request.contextPath}/customer/transferOutsideIBS" method="post" modelAttribute="paymentsAndFundTransfer"> 
<div id="wrapper">
			...
			<spring:option value="2" label="Account 1"/>	
			<spring:option value="3" label="Account 2"/>	
			<spring:option value="4" label="Account 3"/>				
			</spring:select>	
			<br/>	
           ...
           <br>
			...
			<spring:input path="remarks" type ="text" placeholder="put remarks.."/>
